# Generated by Django 5.1.3 on 2024-11-30 01:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('master', 'Мастер бригады'), ('logistician', 'Логист'), ('dispatcher', 'Центральный диспетчер'), ('subdivision_manager', 'Руководство подразделения'), ('admin', 'Администратор')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actual_time_of_work_at_the_facility', models.PositiveIntegerField(blank=True, null=True)),
                ('actual_time_of_waiting_at_the_facility', models.PositiveIntegerField(blank=True, null=True)),
                ('closed', models.BooleanField(default=False)),
